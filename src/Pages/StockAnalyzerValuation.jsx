  ...
  return (
    <div className="col border-start border-bottom border-end">
      <div className="row align-items-center m-2 mt-5">
          ...
          <Plot data={[PE, PEmovingAvg]} layout={{width: valuationGraphDim, height: 400 , yaxis: {range:[0, PEyAxisHighLim]} ,margin: {t:40}, legend: { x: 1, xanchor: 'right', y: 1}}}/>
      ...
      <div className="row align-items-center m-2 mt-5">
        ...
        <Plot data={[PB, PBmovingAvg]} layout={{width: valuationGraphDim, height: 400 , margin: {t:40}, legend: { x: 1, xanchor: 'right', y: 1}}}/> 
